...
//        mFinishAnimator.setInterpolator(new OvershootInterpolator());
        ...
        mValueTextSize = DensityUtils.sp2px(getContext(), 60);
        mSubTextSize = DensityUtils.sp2px(getContext(), 14);

        mValueStr = String.valueOf(mCurrentValue);
        mSubStr = String.valueOf(mCurrentLength + "公里 | " + mCalories + "千卡");
    }
